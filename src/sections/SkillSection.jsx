...
export default function SkillSection() {
    ...
    return (
        <section id="skills" className={`${isDark ? "bg-dark-quaternary" : "bg-light-quaternary"} px-4 py-16 sm:px-6 md:px-8 lg:px-10 xl:px-40 min-h-[800px]`}>
            <div className="max-w-4xl mx-auto w-full flex flex-col items-center justify-center mt-15">
                <div>
                <motion.div
                ...
                <div className="bg-red-500 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3  gap-4">
