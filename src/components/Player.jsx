...
export default function Player() {
  ...
  return (
    <div className="absolute left-50 bottom-60 pointer-events-none w-56 h-56">
      <div className="relative w-full h-full">
        ...
        <div className="absolute bottom-10 left-1/2 -translate-x-1/2 w-24 h-15 rounded-full bg-gradient-to-b from-transparent to-black blur-2xl opacity-100 z-10" />
      </div>
